...
public class Jugadores  implements java.io.Serializable {
    ...
    public Jugadores(int codigo, Equipos equipos, String nombre, String procedencia, String altura, Integer peso, String posicion, Set estadisticases) {
       this.codigo = codigo;
    ...
    public String toString() {
        ...
        return "DATOS DEL JUGADOR : "+codigo
                +sl+ "Nombre : "+nombre
                +sl+ "Equipo : "+equipos.getNombre();
    }
